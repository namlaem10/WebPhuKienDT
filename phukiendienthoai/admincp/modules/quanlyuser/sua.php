...
<form action="modules/quanlyuser/xuly.php?id=<?php echo $col['iduser'] ?>" method="post" enctype="multipart/form-data">
<h3>&nbsp;</h3>
<table width="600" border="1">
  ...
  <tr>
    ...
    <tr>
    <td>Phone Number</td>
    <td><input type="text" name="phone" value="<?php echo $col['phone'] ?>"></td>
  </tr>
    <tr>
    <td>Address</td>
